...
import 'package:learn_flutter/page/supervisor/supervisor_page.dart';
...
class ScheduleSupervisorPage extends StatefulWidget {
  FirebaseUser user;

  ScheduleSupervisorPage(this.user);

  @override
  _ScheduleSupervisorPageState createState() => _ScheduleSupervisorPageState(this.user);
}

class _ScheduleSupervisorPageState extends State<ScheduleSupervisorPage> {
  FirebaseUser user;

  _ScheduleSupervisorPageState(this.user);
