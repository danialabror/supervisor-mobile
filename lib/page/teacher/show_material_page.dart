...
class ShowMaterialPage extends StatefulWidget {
  final String a;

  ShowMaterialPage({this.a});

  @override
  _ShowMaterialPageState createState() => _ShowMaterialPageState(a: this.a);
}

class _ShowMaterialPageState extends State<ShowMaterialPage> {
  final String a;

  _ShowMaterialPageState({this.a});
        ...
        builder: (context) => Container(
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                margin: EdgeInsets.only(top: 60.0, bottom: 30.0, left: 60.0, right: 60.0),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: <Widget>[
                    Text('Supervisor :',
                        style: TextStyle(
                            ...
                            fontWeight: FontWeight.bold)),
                    SizedBox(width: 20.0),
                    Text(data != null ? data['supervisor_name'] : '',
                        style:
              ...
              Container(
                margin: EdgeInsets.only(top: 1.0, bottom: 30.0, left: 60.0, right: 60.0),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: <Widget>[
                    Text('Comment :',
