...
class ShowSchedulePage extends StatefulWidget {
  ...
  ShowSchedulePage({this.a,  this.user});

  @override
  _ShowSchedulePageState createState() => _ShowSchedulePageState(a: this.a, user: user);
}
...
class _ShowSchedulePageState extends State<ShowSchedulePage> {
  ...
  _ShowSchedulePageState({this.a, this.user});
                ...
                children: <Widget>[
                  RaisedButton(
                    ...
                    onPressed: () async {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => AddMaterialPage(user: this.user, a: this.a, spr: data['supervisor_name'],)),
                      );
                    },
                    elevation: 4.0,
